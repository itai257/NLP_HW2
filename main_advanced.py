...
from Parser import KDependencyParserAdvanced
import time
...
model = KDependencyParserAdvanced(word_vocab_size, tag_vocab_size, WORD_EMBEDDING_DIM, POS_EMBEDDING_DIM,
                               LSTM_HIDDEN_DIM, MLP_HIDDEN_DIM, train.word_vectors)
...
fig.suptitle('Train results - Advanced model', fontsize=16)
...
# test:
fig, axs = plt.subplots(2, 1, constrained_layout=True)
fig.suptitle('Test results - Advanced model', fontsize=16)
